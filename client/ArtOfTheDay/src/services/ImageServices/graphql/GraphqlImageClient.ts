...
export class GraphqlImageClient implements IImageClient {
    getAllArtworks(): Promise<ArtworkData[]> { throw new Error('GraphQL not yet implemented'); }
    getArtworksFromIds(_: GetArtworksFromIdsCommand): Promise<ArtworkData[]> { throw new Error('GraphQL not yet implemented'); }
    getArtworksFromGenre(_: GetArtworksFromGenreCommand): Promise<IdentityArtworkData[]> { throw new Error('GraphQL not yet implemented'); }
    getArtworksFromArtist(_: GetArtworksFromArtistCommand): Promise<IdentityArtworkData[]> { throw new Error('GraphQL not yet implemented'); }
    getAllGenres(): Promise<GenreData[]> { throw new Error('GraphQL not yet implemented'); }
    getAllArtists(): Promise<ArtistData[]> { throw new Error('GraphQL not yet implemented'); }
